<?php
// Renders a single site as a list item card. Expects $site in scope.
if (!isset($site)) return;
?>
<article class="site-card list-view" 
    ...
    <div class="site-card-content">
        ...
        <div class="site-card-actions">
            <a href="/projet-web-gl21-chabiba/public_html/catalogue/details.php?id=<?= urlencode($site->id) ?>" class="site-card-button">View Details</a>
